    ...
    while True:
        ...
        try: 
            ...
            if values['Nombre'] == 'Ingresa tu nombre' or values['Nombre'] == '':
                ...
                usuario = {'Nombre': values['Nombre'], 'Edad':values['Edad'], 'Genero' : values['Genero'], 'Dificultad': values['Dificultad'], 'Fecha': fecha,'Hora': hora, 'Puntaje': 0, 'Carteles': values['cartelesSi'], 'Imagenes': values['imagenesSi'], 'CantJugado': 0, 'Estado': '', 'NombreEvento' : '', 'NumeroPartida': 0, 'Tablero': []}
...
def interfazUsuario(usuario):
    ...
    layout = [ [sg.Text('CLICK EN LA SONRISA PARA JUGAR')],
               [sg.Button('JUGAR', key  = 'Jugar', size = (20,5))],
